...
typedef CGAL::Alpha_shape_vertex_base_3<Gt_3,
                                        CGAL::Default,
                                        CGAL::Tag_true,
                                        CGAL::Tag_true> Vb_3;
typedef CGAL::Alpha_shape_cell_base_3<Gt_3, CGAL::Default,
                                      CGAL::Tag_true,
                                      CGAL::Tag_true> Cb_3;

typedef CGAL::Triangulation_data_structure_3<Vb_3, Cb_3>  Ts_3;
typedef CGAL::Regular_triangulation_3<Gt_3, Ts_3> Triangulation_3;
typedef CGAL::Alpha_shape_3<Triangulation_3,
                            CGAL::Tag_true> Alpha_shape_3;
